...
For linking within your documentation, use locale-prefixed paths like `/en/docs/essentials/markdown-syntax`.

::code-preview
---
class: "[&>div]:*:my-0"
---
[Installation](/en/docs/essentials/markdown-syntax)
