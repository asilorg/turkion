...
For linking within your documentation, use locale-prefixed paths like `/uz/docs/essentials/markdown-syntax`.

::code-preview
---
class: "[&>div]:*:my-0"
---
[Installation](/uz/docs/essentials/markdown-syntax)

#code
```mdc
[Installation](/docs/essentials/markdown-syntax)
```
::
